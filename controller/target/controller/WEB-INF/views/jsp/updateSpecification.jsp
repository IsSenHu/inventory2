            ...
            <div class="page-content">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-8" style="text-align: right">
                        <a href="${pageContext.request.contextPath}/pageSpecification.action?currentPage=${currentPage}">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="row" style="text-align: center;">
                            ...
                            <div class="col-xs-8">
                                <form action="${pageContext.request.contextPath}/updateSpecification.action" method="post">
                                    <input type="hidden" name="currentPage" value="${currentPage}"/>
                                    <input type="hidden" value="${specification.specificationId}" name="specificationId"/>
                                    <table id="simple-table" class="table  table-bordered table-hover" style="text-align: center;">
                                        <tbody>
                                            <tr>
                                                <td style="width: 20%;"></td>
                                                <td>
                                                    <input name="specificationName" value="<c:out value="${specification.specificationName}"/>" class="form-control" placeholder="请输入规格名称"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td></td>
