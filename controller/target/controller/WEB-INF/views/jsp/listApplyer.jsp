                    ...
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="col-xs-2">
                                        <input type="text" class="form-control" placeholder="请输入编号" name="applyerId">
                                    </div>
                                    <div class="col-xs-2">
                                        <input type="text" class="form-control" placeholder="请输入使用者名称" name="applyerName">
                                    </div>
                                    <div class="col-xs-4">
                                    </div>
                                    ...
                                    <div class="col-xs-1" style="text-align: left;">
                                        <a href="${pageContext.request.contextPath}/toAddApplyer.action?currentPage=${page.currentPage}">
                                ...
                                <table id="simple-table" class="table  table-bordered table-hover" style="text-align: center;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width:20%; text-align: center;">使用者名称</th>
                                            <th style="width:20%; text-align: center;">所属运动</th>
                                            <th style="width:40%; text-align: center;">操作</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <c:forEach items="${page.content}" var="applyer">
                                            <tr>
                                                <td>${applyer.applyerId}</td>
                                                <td><c:out value="${applyer.applyerName}"></c:out></td>
                                                <td><c:out value="${applyer.sport.sportName}"></c:out></td>
                                                <td>
                                                    <a href="${pageContext.request.contextPath}/showApplyer.action?applyerId=${applyer.applyerId}&currentPage=${page.currentPage}">
                                                    <button style="width: 66px;height: 32px; border-radius: 6px; background-color: green; color: #FFFFFF;">修改</button>
                                                    </a>

                                                    <a href="${pageContext.request.contextPath}/deleteApplyer.action?applyerId=${applyer.applyerId}&currentPage=${page.currentPage}">
                    ...
                    <ul class="pagination">
                        <c:choose>
                            <c:when test="${page.currentPage == 1}">
                                <li><a href="${pageContext.request.contextPath}/pageApplyer.action?currentPage=1">首页</a></li>
                                <li><a href="${pageContext.request.contextPath}/pageApplyer.action?currentPage=${page.currentPage + 1}">下一页</a></li>
                                <li><a href="${pageContext.request.contextPath}/pageApplyer.action?currentPage=${page.totalPage}">尾页</a></li>
                            </c:when>
                            <c:when test="${page.currentPage == page.totalPage}">
                                <li><a href="${pageContext.request.contextPath}/pageApplyer.action?currentPage=1">首页</a></li>
                                <li><a href="${pageContext.request.contextPath}/pageApplyer.action?currentPage=${page.currentPage - 1}">上一页</a></li>
                                <li><a href="${pageContext.request.contextPath}/pageApplyer.action?currentPage=${page.totalPage}">尾页</a></li>
                            </c:when>
                            <c:otherwise>
                                <li><a href="${pageContext.request.contextPath}/pageApplyer.action?currentPage=1">首页</a></li>
            ...
            <c:if test="${find != null}">
                <center>
                    <ul class="pagination">
                        <c:choose>
                            <c:when test="${page.currentPage == 1}">
                                <li><a href="${pageContext.request.contextPath}/findApplyer.action?applyerId=${applyerId}&applyerName=${applyerName}&currentPage=1">首页</a></li>
                                <li><a href="${pageContext.request.contextPath}/findApplyer.action?applyerId=${applyerId}&applyerName=${applyerName}&currentPage=${page.currentPage + 1}">下一页</a></li>
                                <li><a href="${pageContext.request.contextPath}/findApplyer.action?applyerId=${applyerId}&applyerName=${applyerName}&currentPage=${page.totalPage}">尾页</a></li>
                            </c:when>
                            <c:when test="${page.currentPage == page.totalPage}">
                                <li><a href="${pageContext.request.contextPath}/findApplyer.action?applyerId=${applyerId}&applyerName=${applyerName}&currentPage=1">首页</a></li>
                                <li><a href="${pageContext.request.contextPath}/findApplyer.action?applyerId=${applyerId}&applyerName=${applyerName}&currentPage=${page.currentPage - 1}">上一页</a></li>
                                <li><a href="${pageContext.request.contextPath}/findApplyer.action?applyerId=${applyerId}&applyerName=${applyerName}&currentPage=${page.totalPage}">尾页</a></li>
                            </c:when>
                            <c:otherwise>
                                <li><a href="${pageContext.request.contextPath}/findApplyer.action?applyerId=${applyerId}&applyerName=${applyerName}&currentPage=1">首页</a></li>
...
<script type="text/javascript">
    ...
    * */
    $("#find").click(function () {
        var applyerId = $("input[name='applyerId']").val();
        var applyerName = $("input[name='applyerName']").val();
        location.href = '${pageContext.request.contextPath}/findApplyer.action?applyerId=' + applyerId + '&applyerName=' + applyerName;
    });
</script>
