            ...
            <div class="page-content">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-8" style="text-align: right">
                        <a href="${pageContext.request.contextPath}/pageMaterial.action?currentPage=${currentPage}">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="row" style="text-align: center;">
                            ...
                            <div class="col-xs-8">
                                <form action="${pageContext.request.contextPath}/updateMaterial.action" method="post">
                                    ...
                                    <table id="simple-table" class="table  table-bordered table-hover" style="text-align: center;">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <input name="materialName" value="<c:out value="${material.materialName}"/>" class="form-control" placeholder="请输入材质名称"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td></td>
