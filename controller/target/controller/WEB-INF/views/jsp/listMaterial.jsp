                    ...
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="col-xs-2">
                                        <input type="text" class="form-control" placeholder="请输入编号" name="materialId"/>
                                    </div>
                                    <div class="col-xs-2">
                                        <input type="text" class="form-control" placeholder="请输入材质名称" name="materialName"/>
                                    </div>
                                    <div class="col-xs-4">
                                    </div>
                                    ...
                                    <div class="col-xs-1" style="text-align: left;">
                                        <a href="${pageContext.request.contextPath}/toAddMaterial.action?currentPage=${page.currentPage}">
                                ...
                                <table id="simple-table" class="table  table-bordered table-hover" style="text-align: center;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width:30%; text-align: center;">材质名称</th>
                                    ...
                                    <tbody>
                                        <c:forEach items="${page.content}" var="material">
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="${pageContext.request.contextPath}/showMaterial.action?materialId=${material.materialId}&currentPage=${page.currentPage}">
                                                    <button style="width: 66px;height: 32px; border-radius: 6px; background-color: green; color: #FFFFFF;">修改</button>
                                                    </a>

                                                    <a href="${pageContext.request.contextPath}/deleteMaterial.action?materialId=${material.materialId}&currentPage=${page.currentPage}">
                    ...
                    <ul class="pagination">
                        <c:choose>
                            <c:when test="${page.currentPage == 1}">
                                <li><a href="${pageContext.request.contextPath}/pageMaterial.action?currentPage=1">首页</a></li>
                                <li><a href="${pageContext.request.contextPath}/pageMaterial.action?currentPage=${page.currentPage + 1}">下一页</a></li>
                                <li><a href="${pageContext.request.contextPath}/pageMaterial.action?currentPage=${page.totalPage}">尾页</a></li>
                            </c:when>
                            <c:when test="${page.currentPage == page.totalPage}">
                                <li><a href="${pageContext.request.contextPath}/pageMaterial.action?currentPage=1">首页</a></li>
                                <li><a href="${pageContext.request.contextPath}/pageMaterial.action?currentPage=${page.currentPage - 1}">上一页</a></li>
                                <li><a href="${pageContext.request.contextPath}/pageMaterial.action?currentPage=${page.totalPage}">尾页</a></li>
                            </c:when>
                            <c:otherwise>
                                <li><a href="${pageContext.request.contextPath}/pageMaterial.action?currentPage=1">首页</a></li>
            ...
            <c:if test="${page.rowsTotal > 10}">
                <center>
                    <ul class="pagination">
                        <c:choose>
                            <c:when test="${page.currentPage == 1}">
                                <li><a href="${pageContext.request.contextPath}/findMaterial.action?materialId=${materialId}&materialName=${materialName}&currentPage=1">首页</a></li>
                                <li><a href="${pageContext.request.contextPath}/findMaterial.action?materialId=${materialId}&materialName=${materialName}&currentPage=${page.currentPage + 1}">下一页</a></li>
                                <li><a href="${pageContext.request.contextPath}/findMaterial.action?materialId=${materialId}&materialName=${materialName}&currentPage=${page.totalPage}">尾页</a></li>
                            </c:when>
                            <c:when test="${page.currentPage == page.totalPage}">
                                <li><a href="${pageContext.request.contextPath}/findMaterial.action?materialId=${materialId}&materialName=${materialName}&currentPage=1">首页</a></li>
                                <li><a href="${pageContext.request.contextPath}/findMaterial.action?materialId=${materialId}&materialName=${materialName}&currentPage=${page.currentPage - 1}">上一页</a></li>
                                <li><a href="${pageContext.request.contextPath}/findMaterial.action?materialId=${materialId}&materialName=${materialName}&currentPage=${page.totalPage}">尾页</a></li>
                            </c:when>
                            <c:otherwise>
                                <li><a href="${pageContext.request.contextPath}/findMaterial.action?materialId=${materialId}&materialName=${materialName}&currentPage=1">首页</a></li>
...
<script type="text/javascript">
    ...
    * */
    $("#find").click(function () {
        ...
        location.href = '${pageContext.request.contextPath}/findMaterial.action?materialId=' + materialId + '&materialName=' + materialName;
    });
</script>
