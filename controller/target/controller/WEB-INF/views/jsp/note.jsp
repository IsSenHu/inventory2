                                ...
                                <table id="simple-table" class="table  table-bordered table-hover" style="text-align: center;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width:20%; text-align: center;">操作的人</th>
                                            <th style="width:20%; text-align: center;">操作内容</th>
                                            <th style="width:20%; text-align: center;">操作结果</th>
                                    ...
                                    <tbody>
                                        <c:forEach items="${page.content}" var="note">
                                            <tr>
                                                <td>${note.inNoteId}</td>
                                                <td><c:out value="${note.operationPerson.username}"></c:out></td>
                                                <td><c:out value="${note.operationContent}"></c:out></td>
                                                <td><c:out value="${note.operationResult}"></c:out></td>
                                                <td><fmt:formatDate value="${note.operationTime}" pattern="yyyy年MM月dd日 HH时mm分ss秒"></fmt:formatDate></td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
                                </table>
                    ...
                    <ul class="pagination">
                        <c:choose>
                            <c:when test="${page.currentPage == 1}">
                                <li><a href="${pageContext.request.contextPath}/pageNote.action?currentPage=1">首页</a></li>
                                <li><a href="${pageContext.request.contextPath}/pageNote.action?currentPage=${page.currentPage + 1}">下一页</a></li>
                                <li><a href="${pageContext.request.contextPath}/pageNote.action?currentPage=${page.totalPage}">尾页</a></li>
                            </c:when>
                            <c:when test="${page.currentPage == page.totalPage}">
                                <li><a href="${pageContext.request.contextPath}/pageNote.action?currentPage=1">首页</a></li>
                                <li><a href="${pageContext.request.contextPath}/pageNote.action?currentPage=${page.currentPage - 1}">上一页</a></li>
                                <li><a href="${pageContext.request.contextPath}/pageNote.action?currentPage=${page.totalPage}">尾页</a></li>
                            </c:when>
                            <c:otherwise>
                                <li><a href="${pageContext.request.contextPath}/pageNote.action?currentPage=1">首页</a></li>
