                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="row" style="text-align: center;">
                            ...
                            <div class="col-xs-8">
                                <form action="${pageContext.request.contextPath}/addBrand.action" method="post">
                                    ...
                                    <table id="simple-table" class="table  table-bordered table-hover" style="text-align: center;">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <input name="brandName" class="form-control" placeholder="请输入品牌名称"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>品牌公司名称:</td>
                                                <td>
                                                    <input name="brandCompanyName" class="form-control" placeholder="请输入品牌公司名称"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td></td>
