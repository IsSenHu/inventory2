                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="row">
                            ...
                            <div id="todayItemsNumber" class="col-xs-8" style="height: 400px;">
                            </div>
                            <div class="col-xs-2"></div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-xs-2"></div>
                            <div id="todayItemsMoney" class="col-xs-8" style="height: 400px;">
                            </div>
                            <div class="col-xs-2"></div>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    var myChart = echarts.init(document.getElementById('todayItemsNumber'));

    // 指定图表的配置项和数据
    var option = {
        title: {
            text: '${inventoryResult.title}'
        },
        tooltip: {
        },
        legend: {
            data:['${inventoryResult.legend}']
        },
        xAxis: {
            data: [
                <c:forEach items="${inventoryResult.xAxis}" varStatus="i" var="data">
                <c:if test="${i.count == inventoryResult.xAxisSize}">
                    "${data}"
                </c:if>
                <c:if test="${i.count < inventoryResult.xAxisSize}">
                    "${data}",
        ...
        series: [{
            name: '${inventoryResult.seriesName}',
            type: '${inventoryResult.seriesType}',
            data: [
                <c:forEach items="${inventoryResult.data}" varStatus="i" var="data">
                    <c:if test="${i.count == inventoryResult.dataSize}">
                        ${data}
                    </c:if>
                    <c:if test="${i.count < inventoryResult.dataSize}">
                        ${data},
...
//    todayItemsMoney
    var myChart2 = echarts.init(document.getElementById('todayItemsMoney'));

    // 指定图表的配置项和数据
    var option2 = {
        title: {
            text: '${doubleInventoryResult.title}'
        },
        tooltip: {
        },
        legend: {
            data:['${doubleInventoryResult.legend}']
        },
        xAxis: {
            data: [
                <c:forEach items="${doubleInventoryResult.xAxis}" varStatus="i" var="data">
                <c:if test="${i.count == doubleInventoryResult.xAxisSize}">
                "${data}"
                </c:if>
                <c:if test="${i.count < doubleInventoryResult.xAxisSize}">
                "${data}",
        ...
        series: [{
            name: '${doubleInventoryResult.seriesName}',
            type: '${doubleInventoryResult.seriesType}',
            data: [
                <c:forEach items="${doubleInventoryResult.data}" varStatus="i" var="data">
                <c:if test="${i.count == doubleInventoryResult.dataSize}">
                ${data}
                </c:if>
                <c:if test="${i.count < doubleInventoryResult.dataSize}">
                ${data},
