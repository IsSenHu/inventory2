                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="row" style="text-align: center;">
                            ...
                            <div class="col-xs-8">
                                <form action="${pageContext.request.contextPath}/addItem.action" method="post" enctype="multipart/form-data">
                                    ...
                                    <table id="simple-table" class="table  table-bordered table-hover" style="text-align: center;">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" name="itemName" class="form-control" placeholder="请输入商品名称"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <select name="specification.specificationId" class="form-control">
                                                        <c:forEach items="${specifications}" var="specification">
                                                            <option value="${specification.specificationId}">${specification.specificationName}</option>
                                                        </c:forEach>
                                                    </select>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" name="suggestRetailPrice" class="form-control" placeholder="请输入建议零售价"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>实际单价（元）:</td>
                                                <td>
                                                    <input type="text" name="unitPrice" class="form-control" placeholder="请输入实际单价"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <select name="applyer.applyerId" class="form-control">
                                                        <c:forEach items="${applyers}" var="applyer">
                                                            <option value="${applyer.applyerId}">${applyer.applyerName}</option>
                                                        </c:forEach>
                                                    </select>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>上市时间:</td>
                                                <td>
                                                    <input type="text" name="timeToMarket" class="form-control" placeholder="请选择上市时间"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <select name="sportItem.sportItemId" class="form-control">
                                                        <c:forEach items="${sportItems}" var="sportItem">
                                                            <option value="${sportItem.sportItemId}">${sportItem.sportItemName}</option>
                                                        </c:forEach>
                                                    </select>
                                                </td>
                                            </tr>
