                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <div class="col-xs-1" style="text-align: right;">
                                    <select name="outStatuValue" class="form-control">
                                        <option value="">出库单状态</option>
                            ...
                            <div class="col-xs-12">
                                <table id="simple-table" class="table  table-bordered table-hover" style="text-align: center;">
                                    ...
                                    <tr>
                                        ...
                                        <th style="width:15%; text-align: center;">审核人</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                        <c:forEach items="${page.content}" var="outOrder">
                                            <tr>
                                                ...
                                                <td>${outOrder.verfyUser.realName}</td>
                                            </tr>
                                            <tr>
                                                <td colspan="6">
                    ...
                    <ul class="pagination">
                        <c:choose>
                            <c:when test="${page.currentPage == 1}">
                                <li><a href="${pageContext.request.contextPath}/pageOut.action?currentPage=1">首页</a></li>
                                <li><a href="${pageContext.request.contextPath}/pageOut.action?currentPage=${page.currentPage + 1}">下一页</a></li>
                                <li><a href="${pageContext.request.contextPath}/pageOut.action?currentPage=${page.totalPage}">尾页</a></li>
                            </c:when>
                            <c:when test="${page.currentPage == page.totalPage}">
                                <li><a href="${pageContext.request.contextPath}/pageOut.action?currentPage=1">首页</a></li>
                                <li><a href="${pageContext.request.contextPath}/pageOut.action?currentPage=${page.currentPage - 1}">上一页</a></li>
                                <li><a href="${pageContext.request.contextPath}/pageOut.action?currentPage=${page.totalPage}">尾页</a></li>
                            </c:when>
                            <c:otherwise>
                                <li><a href="${pageContext.request.contextPath}/pageOut.action?currentPage=1">首页</a></li>
            ...
            <c:if test="${page.rowsTotal > 10}">
                <center>
                    <ul class="pagination">
                        <c:choose>
                            <c:when test="${page.currentPage == 1}">
                                <li><a href="${pageContext.request.contextPath}/findOut.action?outOrderId=${outOrderId}&start=${start}&end=${end}&outStatuValue=${outStatuValue}&currentPage=1">首页</a></li>
                                <li><a href="${pageContext.request.contextPath}/findOut.action?outOrderId=${outOrderId}&start=${start}&end=${end}&outStatuValue=${outStatuValue}&currentPage=${page.currentPage + 1}">下一页</a></li>
                                <li><a href="${pageContext.request.contextPath}/findOut.action?outOrderId=${outOrderId}&start=${start}&end=${end}&outStatuValue=${outStatuValue}&currentPage=${page.totalPage}">尾页</a></li>
                            </c:when>
                            <c:when test="${page.currentPage == page.totalPage}">
                                <li><a href="${pageContext.request.contextPath}/findOut.action?outOrderId=${outOrderId}&start=${start}&end=${end}&outStatuValue=${outStatuValue}&currentPage=1">首页</a></li>
                                <li><a href="${pageContext.request.contextPath}/findOut.action?outOrderId=${outOrderId}&start=${start}&end=${end}&outStatuValue=${outStatuValue}&currentPage=${page.currentPage - 1}">上一页</a></li>
                                <li><a href="${pageContext.request.contextPath}/findOut.action?outOrderId=${outOrderId}&start=${start}&end=${end}&outStatuValue=${outStatuValue}&currentPage=${page.totalPage}">尾页</a></li>
                            </c:when>
                            <c:otherwise>
                                <li><a href="${pageContext.request.contextPath}/findOut.action?outOrderId=${outOrderId}&start=${start}&end=${end}&outStatuValue=${outStatuValue}&currentPage=1">首页</a></li>
...
<script type="text/javascript">
    ...
    $("#find").click(function () {
        ...
        var outStatuValue = $("select[name='outStatuValue']").val();
        var data = 'outOrderId=' + outOrderId + '&start=' + start + '&end=' + end + '&outStatuValue=' + outStatuValue;
        location.href = '${pageContext.request.contextPath}/findOut.action?' + data + '&currentPage=${page.currentPage}';
    });
</script>
