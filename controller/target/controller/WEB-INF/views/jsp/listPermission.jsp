    ...
    <div class="main-content">
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <div class="col-xs-1" style="text-align: left;">
                                        <input id="addbuttom" onclick="add()" style="width: 66px;height: 32px; border-radius: 6px; background-color: #D15B47; color: #FFFFFF;" type="button" value="添加">
                                    </div>
                                </div>
                            </div>
                        <hr>
                                ...
                                <table id="simple-table" class="table  table-bordered table-hover" style="text-align: center;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width:20%; text-align: center;">权限名字</th>
                                            <th style="width:20%; text-align: center;">权限说明</th>
                                    ...
                                    <tbody>
                                        <c:forEach items="${page.content}" var="permission">
                                            <tr>
                                                ...
                                                <td>
                                                    <button name="updateUrl" value="${permission.permissionId}" style="width: 126px;height: 32px; border-radius: 6px; background-color: cornflowerblue; color: #FFFFFF;">管理权限资源</button>

                                                    <button name="updatePermission" value="${permission.permissionId}" style="width: 66px;height: 32px; border-radius: 6px; background-color: green; color: #FFFFFF;">修改</button>
                                                    <script>

                                                    </script>
                                                    <a href="${pageContext.request.contextPath}/deletePermission.action?permissionId=${permission.permissionId}&currentPage=${page.currentPage}">
                                                        <button style="width: 66px;height: 32px; border-radius: 6px; background-color: red; color: #FFFFFF;">删除</button>
                                                    </a>
                                                </td>
                                            </tr>
                                        </c:forEach>
        ...
        <div id="urls">
            <table class="table table-bordered" style="text-align: center;">
                ...
                <caption>管理权限资源</caption>
                <tr>
                    <th style="width:50%;">已拥有的资源</th>
                    <th>所有的权限</th>
                </tr>
                <tr>
                    <td style="height: 186px; overflow-y: scroll;">
                        <div id="my">
                        </div>
                    </td>
                    <td id="all" style="height: 186px; overflow-y: scroll;">
                    </td>
                </tr>
            </table>
            <div class="col-xs-6" style="text-align: right;">
                <input id="updateUrls" style="width: 66px;height: 32px; border-radius: 6px; background-color: #FFB752; color: green;" type="button" value="保存">
            </div>
            <div class="col-xs-6" style="text-align: left;">
                <input onclick="close4()" style="width: 66px;height: 32px; border-radius: 6px;" type="button" value="关闭">
            </div>
        </div>
        ...
        <div id="update">
            <table class="table table-bordered">
                <input type="hidden" name="permissionId"/>
                <caption>修改权限信息</caption>
                <tr>
                    <td>权限名称:</td>
                    <td>
                        <input type="text" name="oldPermissionName" class="form-control"/>
                    </td>
                </tr>
                <tr>
                    <td>权限说明:</td>
                    <td>
                        <textarea name="oldDescription" class="form-control" rows="3"></textarea>
                    </td>
                </tr>
            </table>
            <div class="col-xs-6" style="text-align: right;">
                <input id="updatePermissionSubmit" style="width: 66px;height: 32px; border-radius: 6px; background-color: #FFB752; color: green;" type="button" value="提交">
            </div>
            <div class="col-xs-6" style="text-align: left;">
            ...
            <table class="table table-bordered" style="text-align: center;">
                <tr>
                    ...
                    <td style="width: 70%; padding: 0px;">
                        <input type="text" class="form-control" name="newPermissionName" placeholder="请输入权限名称"/>
                    </td>
                </tr>
                <tr>
                    <td style="width: 30%; padding: 0px; line-height: 30px;">
                    ...
                    <td style="width: 70%; padding: 0px;">
                        <textarea class="form-control" name="newDescription" rows="3"></textarea>
                    </td>
                </tr>
            </table>
            <div class="col-xs-6" style="text-align: right;">
                <input id="toAddPermission" style="width: 66px;height: 32px; border-radius: 6px; background-color: #FFB752; color: green;" type="button" value="确认">
            </div>
            <div class="col-xs-6" style="text-align: left;">
                    ...
                    <ul class="pagination">
                        <c:choose>
                            <c:when test="${page.currentPage == 1}">
                                <li><a href="${pageContext.request.contextPath}/pagePermission.action?currentPage=1">首页</a></li>
                                <li><a href="${pageContext.request.contextPath}/pagePermission.action?currentPage=${page.currentPage + 1}">下一页</a></li>
                                <li><a href="${pageContext.request.contextPath}/pagePermission.action?currentPage=${page.totalPage}">尾页</a></li>
                            </c:when>
                            <c:when test="${page.currentPage == page.totalPage}">
                                <li><a href="${pageContext.request.contextPath}/pagePermission.action?currentPage=1">首页</a></li>
                                <li><a href="${pageContext.request.contextPath}/pagePermission.action?currentPage=${page.currentPage - 1}">上一页</a></li>
                                <li><a href="${pageContext.request.contextPath}/pagePermission.action?currentPage=${page.totalPage}">尾页</a></li>
                            </c:when>
                            <c:otherwise>
                                <li><a href="${pageContext.request.contextPath}/pagePermission.action?currentPage=1">首页</a></li>
...
<script type="text/javascript">
    ...
    function add(){
        $("#addPermission").css("display","block");
    }
    function close3() {
    ...
    $("button[name='updatePermission']").click(function () {
        var permissionId = this.value;
        console.log(permissionId);
        $.ajax({
            type : 'post',
            url : '${pageContext.request.contextPath}/showPermission.action',
            data : 'permissionId=' + permissionId,
            success : function (data) {
                console.log(data);
                var json = $.parseJSON(data);
                $("input[name='oldPermissionName']").val(json.permissionName);
                $("textarea[name='oldDescription']").html(json.description);
                $("input[name='permissionId']").val(json.permissionId);
                $("#update").css("display", "block");
            }
        });
    });
    $("#updatePermissionSubmit").click(function () {
        var permissionName = $("input[name='oldPermissionName']").val();
        var description = $("textarea[name='oldDescription']").html();
        var permissionId = $("input[name='permissionId']").val();
        $.ajax({
            type : 'post',
            url : '${pageContext.request.contextPath}/updatePermission.action',
            data : 'permissionId=' + permissionId + '&permissionName=' + permissionName + '&description=' + description,
            success : function (data) {
                var json = $.parseJSON(data);
                if(json.name == 'noInput'){
                    alert("没有输入");
                    return;
    ...
    $("#toAddPermission").click(function () {
        var permissionName = $("input[name='newPermissionName']").val();
        var description = $("textarea[name='newDescription']").val();
        console.log(permissionName);
        console.log(description);
        $.ajax({
            type : 'post',
            url : '${pageContext.request.contextPath}/addPermission.action',
            ...
            success : function (data) {
                ...
                if(json.name == 'noInput'){
                    ...
                    alert("添加成功");
                    location.href = '${pageContext.request.contextPath}/pagePermission.action?currentPage=${page.currentPage}';
                }
            }
        });
    });
    $("button[name='updateUrl']").click(function () {
        var permissionId = this.value;
        $.ajax({
            type : 'post',
            url : '${pageContext.request.contextPath}/showUrls.action',
            data : 'permissionId=' + permissionId,
            success : function (data) {
                var json = $.parseJSON(data);
                $("#all").empty();
                ...
                for(index in urls){
                    var url = urls[index];
                    console.log(url);
//                <p><span class="dss">/pageItem.action</span></p>
                    var p = '<p><span class="dss">' + url.url + '</span></p>';
                    console.log(p);
                    $("#my").append(p);
                }
                var urls = json.u;
                for(var i = 0; i < urls.length; i++){
                    var url = urls[i];
                    //                <label><input name="url" type="checkbox" value="">选项 1</label>
                    var l = '<label><input name="url" type="checkbox" value="' + url.urlId + '">' + url.url + '</label><br/>';
                    console.log(l);
                    $("#all").append(l);
                }
                $("input[name='permissionId']").val(permissionId);
                $("#urls").css("display", "block");
            }
        });
    });
    $("#updateUrls").click(function () {
        var urls = '';
        ...
        var urlStr = '';
        if(urls.length >= 2){
            urlStr = urls.substr(0, urls.length - 1);
        }
        console.log("urlStr:" + urlStr);
        var permissionId = $("input[name='permissionId']").val();
        $.ajax({
            type : 'post',
            url : '${pageContext.request.contextPath}/updatePermissionUrl.action',
            data : 'permissionId=' + permissionId + '&urlStr=' + urlStr,
            success : function (data) {
                var json = $.parseJSON(data);
