...
<script type="text/javascript">
    ...
    var option = {
        title: {
            text: '${todayAllItemResult.title}'
        },
        tooltip: {
        },
        legend: {
            data:['${todayAllItemResult.legend}']
        },
        xAxis: {
            data: [
                <c:forEach items="${todayAllItemResult.xAxis}" varStatus="i" var="data">
                <c:if test="${i.count == todayAllItemResult.xAxisSize}">
                    "${data}"
                </c:if>
                <c:if test="${i.count < todayAllItemResult.xAxisSize}">
                    "${data}",
        ...
        series: [{
            name: '${todayAllItemResult.seriesName}',
            type: '${todayAllItemResult.seriesType}',
            data: [
                <c:forEach items="${todayAllItemResult.data}" varStatus="i" var="data">
                    <c:if test="${i.count == todayAllItemResult.dataSize}">
                        ${data}
                    </c:if>
                    <c:if test="${i.count < todayAllItemResult.dataSize}">
                        ${data},
    ...
    var option2 = {
        title: {
            text: '${todayAllItemMoney.title}'
        },
        tooltip: {
        },
        legend: {
            data:['${todayAllItemMoney.legend}']
        },
        xAxis: {
            data: [
                <c:forEach items="${todayAllItemMoney.xAxis}" varStatus="i" var="data">
                <c:if test="${i.count == todayAllItemMoney.xAxisSize}">
                "${data}"
                </c:if>
                <c:if test="${i.count < todayAllItemMoney.xAxisSize}">
                "${data}",
        ...
        series: [{
            name: '${todayAllItemMoney.seriesName}',
            type: '${todayAllItemMoney.seriesType}',
            data: [
                <c:forEach items="${todayAllItemMoney.data}" varStatus="i" var="data">
                <c:if test="${i.count == todayAllItemMoney.dataSize}">
                ${data}
                </c:if>
                <c:if test="${i.count < todayAllItemMoney.dataSize}">
                ${data},
