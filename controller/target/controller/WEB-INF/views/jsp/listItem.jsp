                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="col-xs-2">
                                    <input type="text" class="form-control" placeholder="请输入编号" name="itemId">
                                </div>
                                <div class="col-xs-4">
                                ...
                                <div class="col-xs-1" style="text-align: right;">
                                    <button id="find" style="width: 66px;height: 32px; border-radius: 6px; background-color: #438EB9; color: #FFFFFF;">查询</button>
                                </div>
                                <div class="col-xs-1" style="text-align: left;">
                                    <a href="${pageContext.request.contextPath}/toAddItem.action?currentPage=${page.currentPage}">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="hidden-sm hidden-xs btn-group">
                                                        <a href="${pageContext.request.contextPath}/showItem.action?itemId=${item.itemId}&currentPage=${page.currentPage}">
                                                            <button class="btn btn-xs btn-info">
                                                                <i class="ace-icon fa fa-pencil bigger-120"></i>
                                                            </button>
                                                        </a>
                                                        <a href="${pageContext.request.contextPath}/deleteItem.action?itemId=${item.itemId}&currentPage=${page.currentPage}">
                    ...
                    <ul class="pagination">
                        <c:choose>
                            <c:when test="${page.currentPage == 1}">
                                <li><a href="${pageContext.request.contextPath}/pageItem.action?currentPage=1">首页</a></li>
                                <li><a href="${pageContext.request.contextPath}/pageItem.action?currentPage=${page.currentPage + 1}">下一页</a></li>
                                <li><a href="${pageContext.request.contextPath}/pageItem.action?currentPage=${page.totalPage}">尾页</a></li>
                            </c:when>
                            <c:when test="${page.currentPage == page.totalPage}">
                                <li><a href="${pageContext.request.contextPath}/pageItem.action?currentPage=1">首页</a></li>
                                <li><a href="${pageContext.request.contextPath}/pageItem.action?currentPage=${page.currentPage - 1}">上一页</a></li>
                                <li><a href="${pageContext.request.contextPath}/pageItem.action?currentPage=${page.totalPage}">尾页</a></li>
                            </c:when>
                            <c:otherwise>
                                <li><a href="${pageContext.request.contextPath}/pageItem.action?currentPage=1">首页</a></li>
            ...
            <c:if test="${find != null}">
                <center>
                    <ul class="pagination">
                        <c:choose>
                            <c:when test="${page.currentPage == 1}">
                                <li><a href="${pageContext.request.contextPath}/findItem.action?itemId=${itemId}&brandId=${brandId}&sportItemId=${sportItemId}&currentPage=1">首页</a></li>
                                <li><a href="${pageContext.request.contextPath}/findItem.action?itemId=${itemId}&brandId=${brandId}&sportItemId=${sportItemId}&currentPage=${page.currentPage + 1}">下一页</a></li>
                                <li><a href="${pageContext.request.contextPath}/findItem.action?itemId=${itemId}&brandId=${brandId}&sportItemId=${sportItemId}&currentPage=${page.totalPage}">尾页</a></li>
                            </c:when>
                            <c:when test="${page.currentPage == page.totalPage}">
                                <li><a href="${pageContext.request.contextPath}/findItem.action?itemId=${itemId}&brandId=${brandId}&sportItemId=${sportItemId}&currentPage=1">首页</a></li>
                                <li><a href="${pageContext.request.contextPath}/findItem.action?itemId=${itemId}&brandId=${brandId}&sportItemId=${sportItemId}&currentPage=${page.currentPage - 1}">上一页</a></li>
                                <li><a href="${pageContext.request.contextPath}/findItem.action?itemId=${itemId}&brandId=${brandId}&sportItemId=${sportItemId}&currentPage=${page.totalPage}">尾页</a></li>
                            </c:when>
                            <c:otherwise>
                                <li><a href="${pageContext.request.contextPath}/findItem.action?itemId=${itemId}&brandId=${brandId}&sportItemId=${sportItemId}&currentPage=1">首页</a></li>
...
<script type="text/javascript">
    ...
    * */
    $("#find").click(function () {
        ...
        var sportItemId = $("select[name='sportItemId']").val();
        location.href = '${pageContext.request.contextPath}/findItem.action?itemId=' + itemId + '&brandId=' + brandId + '&sportItemId=' + sportItemId;
    });
</script>
