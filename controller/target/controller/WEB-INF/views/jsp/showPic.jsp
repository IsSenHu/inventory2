            ...
            <div class="page-content">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-8" style="text-align: right">
                        <a href="${pageContext.request.contextPath}/showItem.action?itemId=${item.itemId}&currentPage=${currentPage}">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="row" style="text-align: center;">
                            ...
                            <div class="col-xs-8">
                                <form action="${pageContext.request.contextPath}/updatePic.action" method="post">
                                    <input type="hidden" name="currentPage" value="${currentPage}"/>
                                    <input type="hidden" value="${item.itemId}" name="itemId"/>
                                    <input type="hidden" value="${item.picPath}" name="picPath"/>
                                    <table id="simple-table" class="table  table-bordered table-hover" style="text-align: center;">
                                        <tbody>
                                            <tr>
                                                <td style="width: 20%;">现在的图片:</td>
                                                <td>
                                                    <img style="width: 200px; height: 200px; border: 1px solid slategray; padding: 2px;" src="${item.picPath}"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>选择图片:</td>
                                                <td>
                                                    <input type="file" name="pic" class="form-control" placeholder="请选择图片"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td></td>
