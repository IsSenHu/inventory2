            ...
            <div class="page-content">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-8" style="text-align: right">
                        <a href="${pageContext.request.contextPath}/pageApplyer.action?currentPage=${currentPage}">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="row" style="text-align: center;">
                            ...
                            <div class="col-xs-8">
                                <form action="${pageContext.request.contextPath}/updateApplyer.action" method="post">
                                    <input type="hidden" value="${applyer.applyerId}" name="applyerId"/>
                                    ...
                                    <table id="simple-table" class="table  table-bordered table-hover" style="text-align: center;">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <input name="applyerName" value="<c:out value="${applyer.applyerName}"/>" class="form-control" placeholder="请输入使用者名称"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>所属运动:</td>
                                                <td>
                                                    <select name="sport.sportId" class="form-control">
                                                        <c:forEach items="${sports}" var="sport">
                                                            <option <c:if test="${applyer.sport.sportId == sport.sportId}">selected="selected"</c:if> value="${sport.sportId}"><c:out value="${sport.sportName}"></c:out></option>
                                                        </c:forEach>
                                                    </select>
                                                </td>
                                            </tr>
