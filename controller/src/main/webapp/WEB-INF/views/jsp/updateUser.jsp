                                    ...
                                    <table id="simple-table" class="table  table-bordered table-hover" style="text-align: center;">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" value="<c:out value="${sessionScope.user.userId}"></c:out>" disabled class="form-control"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="width: 20%;">用户名:</td>
                                                <td>
                                                    <input type="text" value="<c:out value="${sessionScope.user.username}"></c:out>" name="username" class="form-control"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="width: 20%;">真实姓名:</td>
                                                <td>
                                                    <input value="${sessionScope.user.realName}" type="text" name="realName" class="form-control"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="width: 20%;">联系电话:</td>
                                                <td>
                                                    <input type="text" value="<c:out value="${sessionScope.user.phone}"></c:out>" name="phone" class="form-control"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="width: 20%;">手机号:</td>
                                                <td>
                                                    <input type="text" value="<c:out value="${sessionScope.user.mobilePhone}"></c:out>" name="mobilePhone" class="form-control" disabled/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>邮箱地址:</td>
                                                <td>
                                                    <input value="${sessionScope.user.email}" type="text" name="email" class="form-control"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="width: 20%;">性别:</td>
                                                <td>
                                                    <c:if test="${sessionScope.user.gender.value == 0}">
                                                        未知性别
                                                    </c:if>
                                                    <c:if test="${sessionScope.user.gender.value == 11}">
                                                        男
                                                    </c:if>
                                                    <c:if test="${sessionScope.user.gender.value == 12}">
                                                        女
                                                    </c:if>
                                                </td>
                                            </tr>
