            ...
            <div class="page-content">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-8" style="text-align: right">
                        <a href="${pageContext.request.contextPath}/pageSport.action?currentPage=${currentPage}">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="row" style="text-align: center;">
                            ...
                            <div class="col-xs-8">
                                <form action="${pageContext.request.contextPath}/updateSport.action" method="post">
                                    <input type="hidden" name="currentPage" value="${currentPage}"/>
                                    <input type="hidden" value="${sport.sportId}" name="sportId"/>
                                    <table id="simple-table" class="table  table-bordered table-hover" style="text-align: center;">
                                        <tbody>
                                            <tr>
                                                <td style="width: 20%;"></td>
                                                <td>
                                                    <input name="sportName" value="<c:out value="${sport.sportName}"/>" class="form-control" placeholder="请输入运动名称"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td></td>
