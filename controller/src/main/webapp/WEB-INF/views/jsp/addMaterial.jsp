                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="row" style="text-align: center;">
                            ...
                            <div class="col-xs-8">
                                <form action="${pageContext.request.contextPath}/addMaterial.action" method="post">
                                    <input type="hidden" name="currentPage" value="${currentPage}"/>
                                    <table id="simple-table" class="table  table-bordered table-hover" style="text-align: center;">
                                        <tbody>
                                            <tr>
                                                <td style="width: 20%;">材质名称:</td>
                                                <td>
                                                    <input name="materialName" class="form-control" placeholder="请输入材质名称"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td></td>
