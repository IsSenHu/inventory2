            ...
            <div class="page-content">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-8" style="text-align: right">
                        <a href="${pageContext.request.contextPath}/showPic.action?itemId=${item.itemId}&currentPage=${currentPage}">
                            <button style="width: 86px;height: 32px; border-radius: 6px; background-color: firebrick; color: #FFFFFF;">修改图片</button>
                        </a>
                        <a href="${pageContext.request.contextPath}/pageItem.action?currentPage=${currentPage}">
                        ...
                        <div class="row" style="text-align: center;">
                            ...
                            <div class="col-xs-8">
                                <form action="${pageContext.request.contextPath}/updateItem.action" method="post">
                                    ...
                                    <input type="hidden" name="currentInventory" value="${item.currentInventory}"/>
                                    ...
                                    <table id="simple-table" class="table  table-bordered table-hover" style="text-align: center;">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" value="<c:out value="${item.itemName}"></c:out>" name="itemName" class="form-control"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="width: 20%;">商品品牌:</td>
                                                <td>
                                                    <select name="brand.brandId" class="form-control">
                                                        <c:forEach items="${brands}" var="brand">
                                                        <option <c:if test="${item.brand.brandId == brand.brandId}">selected="selected"</c:if> value="${brand.brandId}">${brand.brandName}</option>
                                                        </c:forEach>
                                                    </select>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <select name="specification.specificationId" class="form-control">
                                                        <c:forEach items="${specifications}" var="specification">
                                                            <option <c:if test="${item.specification.specificationId == specification.specificationId}">selected="selected"</c:if> value="${specification.specificationId}">${specification.specificationName}</option>
                                                        </c:forEach>
                                                    </select>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="width: 20%;">建议零售价（元）:</td>
                                                <td>
                                                    <input value="${item.suggestRetailPrice}" type="text" name="suggestRetailPrice" class="form-control" placeholder="请输入建议零售价"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>实际单价（元）:</td>
                                                <td>
                                                    <input value="${item.unitPrice}" type="text" name="unitPrice" class="form-control" placeholder="请输入实际单价"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="width: 20%;">适用对象:</td>
                                                <td>
                                                    <select name="applyer.applyerId" class="form-control">
                                                        <c:forEach items="${applyers}" var="applyer">
                                                            <option <c:if test="${item.applyer.applyerId == applyer.applyerId}">selected="selected"</c:if> value="${applyer.applyerId}">${applyer.applyerName}</option>
                                                        </c:forEach>
                                                    </select>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>上市时间:</td>
                                                <td>
                                                    <input value="<fmt:formatDate value="${item.timeToMarket}" pattern="yyyy-MM-dd"></fmt:formatDate>" type="text" name="timeToMarket" class="form-control" placeholder="请选择上市时间"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="width: 20%;">材质:</td>
                                                <td>
                                                    <select name="material.materialId" class="form-control">
                                                        <c:forEach items="${materials}" var="material">
                                                            <option <c:if test="${item.material.materialId == material.materialId}">selected="selected"</c:if> value="${material.materialId}">${material.materialName}</option>
                                                        </c:forEach>
                                                    </select>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="width: 20%;">运动物品:</td>
                                                <td>
                                                    <select name="sportItem.sportItemId" class="form-control">
                                                        <c:forEach items="${sportItems}" var="sportItem">
                                                            <option <c:if test="${item.sportItem.sportItemId == sportItem.sportItemId}">selected="selected"</c:if> value="${sportItem.sportItemId}">${sportItem.sportItemName}</option>
                                                        </c:forEach>
                                                    </select>
                                                </td>
                                            </tr>
