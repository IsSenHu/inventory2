                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <div class="col-xs-1" style="text-align: left;">
                                        <a href="${pageContext.request.contextPath}/toAddSpecification.action?currentPage=${page.currentPage}">
                                ...
                                <table id="simple-table" class="table  table-bordered table-hover" style="text-align: center;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width:30%; text-align: center;">规格名称</th>
                                    ...
                                    <tbody>
                                        <c:forEach items="${page.content}" var="specification">
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="${pageContext.request.contextPath}/showSpecification.action?specificationId=${specification.specificationId}&currentPage=${page.currentPage}">
                                                    <button style="width: 66px;height: 32px; border-radius: 6px; background-color: green; color: #FFFFFF;">修改</button>
                                                    </a>

                                                    <a href="${pageContext.request.contextPath}/deleteSpecification.action?specificationId=${specification.specificationId}&currentPage=${page.currentPage}">
                ...
                <ul class="pagination">
                    <c:choose>
                        <c:when test="${page.currentPage == 1}">
                            <li><a href="${pageContext.request.contextPath}/pageSpecification.action?currentPage=1">首页</a></li>
                            <li><a href="${pageContext.request.contextPath}/pageSpecification.action?currentPage=${page.currentPage + 1}">下一页</a></li>
                            <li><a href="${pageContext.request.contextPath}/pageSpecification.action?currentPage=${page.totalPage}">尾页</a></li>
                        </c:when>
                        <c:when test="${page.currentPage == page.totalPage}">
                            <li><a href="${pageContext.request.contextPath}/pageSpecification.action?currentPage=1">首页</a></li>
                            <li><a href="${pageContext.request.contextPath}/pageSpecification.action?currentPage=${page.currentPage - 1}">上一页</a></li>
                            <li><a href="${pageContext.request.contextPath}/pageSpecification.action?currentPage=${page.totalPage}">尾页</a></li>
                        </c:when>
                        <c:otherwise>
                            <li><a href="${pageContext.request.contextPath}/pageSpecification.action?currentPage=1">首页</a></li>
