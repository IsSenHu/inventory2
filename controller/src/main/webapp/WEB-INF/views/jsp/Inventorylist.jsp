                        ...
                        <form>
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <div class="col-xs-2">
                                        <input type="text" class="form-control" placeholder="请输入商品名称" name="">
                                    </div>
                                    <div class="col-xs-4">
                                    ...
                                    <div class="col-xs-1" style="text-align: right;">
                                        <input style="width: 66px;height: 32px; border-radius: 6px; background-color: #438EB9; color: #FFFFFF;" type="submit" value="查询">
                                    </div>
                                </div>
                            </div>
                        </form>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xs-12 col-sm-2">
                                                            <div class="text-center">
                                                                <img height="150" class="thumbnail inline no-margin-bottom" alt="Domain Owner's Avatar" src="img/ymqp.jpg"/>
                                                                <br />
                                                                <div class="width-80 label label-info label-xlg arrowed-in arrowed-in-right">
                                                                    <div class="inline position-relative">
                                                                        <a class="user-title-label" href="#">
                                                                            ...
                                                                            &nbsp;
                                                                            <span class="white">YONEX-VT-ZFLTD</span>
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                            </div>
