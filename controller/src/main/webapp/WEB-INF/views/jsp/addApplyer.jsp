                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="row" style="text-align: center;">
                            ...
                            <div class="col-xs-8">
                                <form action="${pageContext.request.contextPath}/addApplyer.action" method="post">
                                    <input type="hidden" name="currentPage" value="${currentPage}"/>
                                    <table id="simple-table" class="table  table-bordered table-hover" style="text-align: center;">
                                        <tbody>
                                            <tr>
                                                <td style="width: 20%;">使用者名称:</td>
                                                <td>
                                                    <input name="applyerName" class="form-control" placeholder="请输入使用者名称"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>所属运动:</td>
                                                <td>
                                                    <select name="sport.sportId" class="form-control">
                                                        <c:forEach items="${sports}" var="sport">
                                                            <option value="${sport.sportId}"><c:out value="${sport.sportName}"></c:out></option>
                                                        </c:forEach>
                                                    </select>
                                                </td>
                                            </tr>
