                    ...
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="col-xs-2">
                                        <input type="text" class="form-control" placeholder="请输入编号" name="brandId">
                                    </div>
                                    <div class="col-xs-2">
                                        <input type="text" class="form-control" placeholder="请输入公司名称" name="brandCompanyName">
                                    </div>
                                    <div class="col-xs-4">
                                    </div>
                                    ...
                                    <div class="col-xs-1" style="text-align: left;">
                                        <a href="${pageContext.request.contextPath}/toAddBrand.action?currentPage=${page.currentPage}">
                                ...
                                <table id="simple-table" class="table  table-bordered table-hover" style="text-align: center;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width:20%; text-align: center;">品牌名称</th>
                                            <th style="width:20%; text-align: center;">品牌公司名称</th>
                                    ...
                                    <tbody>
                                        <c:forEach items="${page.content}" var="brand">
                                            <tr>
                                                ...
                                                <td><c:out value="${brand.brandCompanyName}"></c:out></td>
                                                <td>
                                                    <a href="${pageContext.request.contextPath}/showBrand.action?brandId=${brand.brandId}&currentPage=${page.currentPage}">
                                                    <button style="width: 66px;height: 32px; border-radius: 6px; background-color: green; color: #FFFFFF;">修改</button>
                                                    </a>

                                                    <a href="${pageContext.request.contextPath}/deleteBrand.action?brandId=${brand.brandId}&currentPage=${page.currentPage}">
                    ...
                    <ul class="pagination">
                        <c:choose>
                            <c:when test="${page.currentPage == 1}">
                                <li><a href="${pageContext.request.contextPath}/pageBrand.action?currentPage=1">首页</a></li>
                                <li><a href="${pageContext.request.contextPath}/pageBrand.action?currentPage=${page.currentPage + 1}">下一页</a></li>
                                <li><a href="${pageContext.request.contextPath}/pageBrand.action?currentPage=${page.totalPage}">尾页</a></li>
                            </c:when>
                            <c:when test="${page.currentPage == page.totalPage}">
                                <li><a href="${pageContext.request.contextPath}/pageBrand.action?currentPage=1">首页</a></li>
                                <li><a href="${pageContext.request.contextPath}/pageBrand.action?currentPage=${page.currentPage - 1}">上一页</a></li>
                                <li><a href="${pageContext.request.contextPath}/pageBrand.action?currentPage=${page.totalPage}">尾页</a></li>
                            </c:when>
                            <c:otherwise>
                                <li><a href="${pageContext.request.contextPath}/pageBrand.action?currentPage=1">首页</a></li>
            ...
            <c:if test="${find != null}">
                <center>
                    <ul class="pagination">
                        <c:choose>
                            <c:when test="${page.currentPage == 1}">
                                <li><a href="${pageContext.request.contextPath}/findBrand.action?brandId=${brandId}&brandCompanyName=${brandCompanyName}&currentPage=1">首页</a></li>
                                <li><a href="${pageContext.request.contextPath}/findBrand.action?brandId=${brandId}&brandCompanyName=${brandCompanyName}&currentPage=${page.currentPage + 1}">下一页</a></li>
                                <li><a href="${pageContext.request.contextPath}/findBrand.action?brandId=${brandId}&brandCompanyName=${brandCompanyName}&currentPage=${page.totalPage}">尾页</a></li>
                            </c:when>
                            <c:when test="${page.currentPage == page.totalPage}">
                                <li><a href="${pageContext.request.contextPath}/findBrand.action?brandId=${brandId}&brandCompanyName=${brandCompanyName}&currentPage=1">首页</a></li>
                                <li><a href="${pageContext.request.contextPath}/findBrand.action?brandId=${brandId}&brandCompanyName=${brandCompanyName}&currentPage=${page.currentPage - 1}">上一页</a></li>
                                <li><a href="${pageContext.request.contextPath}/findBrand.action?brandId=${brandId}&brandCompanyName=${brandCompanyName}&currentPage=${page.totalPage}">尾页</a></li>
                            </c:when>
                            <c:otherwise>
                                <li><a href="${pageContext.request.contextPath}/findBrand.action?abrandId=${brandId}&brandCompanyName=${brandCompanyName}&currentPage=1">首页</a></li>
                                <li><a href="${pageContext.request.contextPath}/findBrand.action?brandId=${brandId}&brandCompanyName=${brandCompanyName}&currentPage=${page.currentPage - 1}">上一页</a></li>
                                <li><a href="${pageContext.request.contextPath}/findBrand.action?brandId=${brandId}&brandCompanyName=${brandCompanyName}&currentPage=${page.currentPage + 1}">下一页</a></li>
                                <li><a href="${pageContext.request.contextPath}/findBrand.action?brandId=${brandId}&brandCompanyName=${brandCompanyName}&currentPage=${page.totalPage}">尾页</a></li>
                            </c:otherwise>
...
<script type="text/javascript">
    ...
    * */
    $("#find").click(function () {
        ...
        var brandCompanyName = $("input[name='brandCompanyName']").val();
        location.href = '${pageContext.request.contextPath}/findBrand.action?brandId=' + brandId + '&brandCompanyName=' + brandCompanyName;
    });
</script>
