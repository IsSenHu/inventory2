                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="row">
                            ...
                            <div id="weekItemsNumber" class="col-xs-10" style="height: 500px;">
                            </div>
                            <div class="col-xs-1"></div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-xs-1"></div>
                            <div id="weekItemsMoney" class="col-xs-10" style="height: 500px;">
                            </div>
                            <div class="col-xs-1"></div>
                        </div>
                    </div>
...
var dom = document.getElementById("weekItemsNumber");
var myChart = echarts.init(dom);
var app = {};
option = null;
option = {
    title: {
        text: '${weekAllItemResult.title}'
    },
    tooltip : {
        trigger: 'axis',
        axisPointer: {
    ...
    legend: {
        data:[
            <c:forEach items="${weekAllItemResult.legend}" varStatus="i" var="itemName">
                <c:if test="${i.count < weekAllItemResult.legendSize}">
                    '${itemName}',
                </c:if>
                <c:if test="${i.count == weekAllItemResult.legendSize}">
                    '${itemName}'
    ...
    series : [
        <c:forEach items="${weekAllItemResult.series}" var="series" varStatus="i">
            <c:if test="${i.count < weekAllItemResult.legendSize}">
                {
                    name:'${series.name}',
                    type:'${series.type}',
...
var dom2 = document.getElementById("weekItemsMoney");
var myChart2 = echarts.init(dom2);
var app2 = {};
option2 = null;
option2 = {
    title: {
        text: '${weekAllItemMoney.title}'
    },
    tooltip : {
        trigger: 'axis',
        axisPointer: {
    ...
    legend: {
        data:[
            <c:forEach items="${weekAllItemMoney.legend}" varStatus="i" var="itemName">
            <c:if test="${i.count < weekAllItemMoney.legendSize}">
            '${itemName}',
            </c:if>
            <c:if test="${i.count == weekAllItemMoney.legendSize}">
            '${itemName}'
    ...
    series : [
        <c:forEach items="${weekAllItemMoney.series}" var="series" varStatus="i">
        <c:if test="${i.count < weekAllItemMoney.legendSize}">
        {
            name:'${series.name}',
            type:'${series.type}',
