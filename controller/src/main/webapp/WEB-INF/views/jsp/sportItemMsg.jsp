            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12" style="text-align: center;">
                        ...
                        <c:if test="${sportItemId == null}">
                            <a href="${pageContext.request.contextPath}/toAddSportItem.action?currentPage=${currentPage}"><button style="width: 86px;height: 32px; border-radius: 6px; background-color: #438EB9; color: #FFFFFF;">继续添加</button></a>
                        </c:if>
                        <c:if test="${sportItemId != null}">
                            <a href="${pageContext.request.contextPath}/showSportItem.action?sportItemId=${sportItemId}&currentPage=${currentPage}"><button style="width: 126px;height: 32px; border-radius: 6px; background-color: yellowgreen; color: #FFFFFF;">再次修改</button></a>
                        </c:if>
                        <a href="${pageContext.request.contextPath}/pageSportItem.action?currentPage=${currentPage}"><button style="width: 126px;height: 32px; border-radius: 6px; background-color: #438EB9; color: #FFFFFF;">返回列表</button></a>
                    </div>
                </div>
            </div><!-- /.page-content -->
        </div>
