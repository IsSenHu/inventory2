                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="row" style="text-align: center;">
                            ...
                            <div class="col-xs-8">
                                <form action="${pageContext.request.contextPath}/addSpecification.action" method="post">
                                    <input type="hidden" name="currentPage" value="${currentPage}"/>
                                    <table id="simple-table" class="table  table-bordered table-hover" style="text-align: center;">
                                        <tbody>
                                            <tr>
                                                <td style="width: 20%;">规格名称:</td>
                                                <td>
                                                    <input name="specificationName" class="form-control" placeholder="请输入规格名称"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td></td>
