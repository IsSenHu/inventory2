    ...
    <div class="main-content">
                                ...
                                <table id="simple-table" class="table  table-bordered table-hover" style="text-align: center;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width:20%; text-align: center;">URL地址</th>
                                            <th style="width:20%; text-align: center;">地址描述</th>
                                            <th style="width:40%; text-align: center;">操作</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <c:forEach items="${page.content}" var="url">
                                            <tr>
                                                <td>${url.urlId}</td>
                                                <td><c:out value="${url.url}"></c:out></td>
                                                <td><c:out value="${url.description}"></c:out></td>
                                                <td>
                                                    <button name="updateUrl" value="${url.urlId}" style="width: 66px;height: 32px; border-radius: 6px; background-color: green; color: #FFFFFF;">修改</button>

                                                    <a href="${pageContext.request.contextPath}/deleteUrl.action?urlId=${url.urlId}&currentPage=${page.currentPage}">
        ...
        <div id="update">
            <table class="table table-bordered">
                ...
                <caption>修改地址</caption>
                <tr>
                    <td>url:</td>
                    <td>
                        <input type="text" name="oldUrl" class="form-control"/>
                    </td>
                </tr>
                <tr>
                    <td>地址说明:</td>
            ...
            <div class="col-xs-6" style="text-align: right;">
                <input id="updateUrlSubmit" style="width: 66px;height: 32px; border-radius: 6px; background-color: #FFB752; color: green;" type="button" value="提交">
            </div>
        ...
        <div id="addUrl">
            ...
            <table class="table table-bordered" style="text-align: center;">
                <tr>
                    ...
                    <td style="width: 70%; padding: 0px;">
                        <input type="text" class="form-control" name="newUrl" placeholder="请输入地址名称"/>
                    </td>
                </tr>
                <tr>
                    <td style="width: 30%; padding: 0px; line-height: 30px;">
            ...
            <div class="col-xs-6" style="text-align: right;">
                <input id="toAddUrl" style="width: 66px;height: 32px; border-radius: 6px; background-color: #FFB752; color: green;" type="button" value="确认">
            </div>
            <div class="col-xs-6" style="text-align: left;">
                    ...
                    <ul class="pagination">
                        <c:choose>
                            <c:when test="${page.currentPage == 1}">
                                <li><a href="${pageContext.request.contextPath}/pageUrl.action?currentPage=1">首页</a></li>
                                <li><a href="${pageContext.request.contextPath}/pageUrl.action?currentPage=${page.currentPage + 1}">下一页</a></li>
                                <li><a href="${pageContext.request.contextPath}/pageUrl.action?currentPage=${page.totalPage}">尾页</a></li>
                            </c:when>
                            <c:when test="${page.currentPage == page.totalPage}">
                                <li><a href="${pageContext.request.contextPath}/pageUrl.action?currentPage=1">首页</a></li>
                                <li><a href="${pageContext.request.contextPath}/pageUrl.action?currentPage=${page.currentPage - 1}">上一页</a></li>
                                <li><a href="${pageContext.request.contextPath}/pageUrl.action?currentPage=${page.totalPage}">尾页</a></li>
                            </c:when>
                            <c:otherwise>
                                <li><a href="${pageContext.request.contextPath}/pageUrl.action?currentPage=1">首页</a></li>
...
<script type="text/javascript">
    ...
    $("button[name='updateUrl']").click(function () {
        ...
        $.ajax({
            type : 'post',
            url : '${pageContext.request.contextPath}/showUrl.action',
            data : 'urlId=' + urlId,
            success : function (data) {
                console.log(data);
                var json = $.parseJSON(data);
                $("input[name='oldUrl']").val(json.url);
                $("textarea[name='oldDescription']").html(json.description);
                $("input[name='urlId']").val(json.urlId);
                $("#update").css("display", "block");
            }
        });
    });
    $("#updateUrlSubmit").click(function () {
        var url = $("input[name='oldUrl']").val();
        var description = $("textarea[name='oldDescription']").html();
        var urlId = $("input[name='urlId']").val();
        $.ajax({
            type : 'post',
            url : '${pageContext.request.contextPath}/updateUrl.action',
            data : 'urlId=' + urlId + '&url=' + url + '&description=' + description,
            success : function (data) {
                var json = $.parseJSON(data);
                if(json.name == 'noInput'){
                    ...
                    alert("修改成功");
                    location.href = '${pageContext.request.contextPath}/pageUrl.action?currentPage=${page.currentPage}';
                }
            }
        });
    });
    $("#toAddUrl").click(function () {
        ...
        $.ajax({
            type : 'post',
            url : '${pageContext.request.contextPath}/addUrl.action',
