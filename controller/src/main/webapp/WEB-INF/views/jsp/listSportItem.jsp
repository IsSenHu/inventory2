                    ...
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="col-xs-2">
                                        <input type="text" class="form-control" placeholder="请输入编号" name="sportItemId"/>
                                    </div>
                                    <div class="col-xs-2">
                                        <input type="text" class="form-control" placeholder="请输入运动物品名称" name="sportItemName"/>
                                    </div>
                                    <div class="col-xs-4">
                                    </div>
                                    <div class="col-xs-1" style="text-align: right;">
                                        <button style="width: 66px;height: 32px; border-radius: 6px; background-color: #438EB9; color: #FFFFFF;" id="find">查询</button>
                                    </div>
                                    <div class="col-xs-1" style="text-align: left;">
                                        <a href="${pageContext.request.contextPath}/toAddSportItem.action?currentPage=${page.currentPage}">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <table id="simple-table" class="table  table-bordered table-hover" style="text-align: center;">
                                    <thead>
                                        <tr>
                                            <th style="width:30%; text-align: center;">编号</th>
                                            <th style="width:30%; text-align: center;">运动物品名称</th>
                                            <th style="width:40%; text-align: center;">操作</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <c:forEach items="${page.content}" var="sportItem">
                                            <tr>
                                                <td>${sportItem.sportItemId}</td>
                                                <td>${sportItem.sportItemName}</td>
                                                <td>
                                                    <a href="${pageContext.request.contextPath}/showSportItem.action?sportItemId=${sportItem.sportItemId}&currentPage=${page.currentPage}">
                                                    <button style="width: 66px;height: 32px; border-radius: 6px; background-color: green; color: #FFFFFF;">修改</button>
                                                    </a>

                                                    <a href="${pageContext.request.contextPath}/deleteSportItem.action?sportItemId=${sportItem.sportItemId}&currentPage=${page.currentPage}">
                    ...
                    <ul class="pagination">
                        <c:choose>
                            <c:when test="${page.currentPage == 1}">
                                <li><a href="${pageContext.request.contextPath}/pageSportItem.action?currentPage=1">首页</a></li>
                                <li><a href="${pageContext.request.contextPath}/pageSportItem.action?currentPage=${page.currentPage + 1}">下一页</a></li>
                                <li><a href="${pageContext.request.contextPath}/pageSportItem.action?currentPage=${page.totalPage}">尾页</a></li>
                            </c:when>
                            <c:when test="${page.currentPage == page.totalPage}">
                                <li><a href="${pageContext.request.contextPath}/pageSportItem.action?currentPage=1">首页</a></li>
                                <li><a href="${pageContext.request.contextPath}/pageSportItem.action?currentPage=${page.currentPage - 1}">上一页</a></li>
                                <li><a href="${pageContext.request.contextPath}/pageSportItem.action?currentPage=${page.totalPage}">尾页</a></li>
                            </c:when>
                            <c:otherwise>
                                <li><a href="${pageContext.request.contextPath}/pageSportItem.action?currentPage=1">首页</a></li>
            ...
            <c:if test="${page.rowsTotal > 10}">
                <center>
                    <ul class="pagination">
                        <c:choose>
                            <c:when test="${page.currentPage == 1}">
                                <li><a href="${pageContext.request.contextPath}/findSportItem.action?sportItemId=${sportItemId}&sportItemName=${sportItemName}&currentPage=1">首页</a></li>
                                <li><a href="${pageContext.request.contextPath}/findSportItem.action?sportItemId=${sportItemId}&sportItemName=${sportItemName}&currentPage=${page.currentPage + 1}">下一页</a></li>
                                <li><a href="${pageContext.request.contextPath}/findSportItem.action?sportItemId=${sportItemId}&sportItemName=${sportItemName}&currentPage=${page.totalPage}">尾页</a></li>
                            </c:when>
                            <c:when test="${page.currentPage == page.totalPage}">
                                <li><a href="${pageContext.request.contextPath}/findSportItem.action?sportItemId=${sportItemId}&sportItemName=${sportItemName}&currentPage=1">首页</a></li>
                                <li><a href="${pageContext.request.contextPath}/findSportItem.action?sportItemId=${sportItemId}&sportItemName=${sportItemName}&currentPage=${page.currentPage - 1}">上一页</a></li>
                                <li><a href="${pageContext.request.contextPath}/findSportItem.action?sportItemId=${sportItemId}&sportItemName=${sportItemName}&currentPage=${page.totalPage}">尾页</a></li>
                            </c:when>
                            <c:otherwise>
                                <li><a href="${pageContext.request.contextPath}/findSportItem.action?sportItemId=${sportItemId}&sportItemName=${sportItemName}&currentPage=1">首页</a></li>
...
<script type="text/javascript">
    ...
    * */
    $("#find").click(function () {
        var sportItemId = $("input[name='sportItemId']").val();
        var sportItemName = $("input[name='sportItemName']").val();
        location.href = '${pageContext.request.contextPath}/findSportItem.action?sportItemId=' + sportItemId + '&sportItemName=' + sportItemName;
    });
</script>
