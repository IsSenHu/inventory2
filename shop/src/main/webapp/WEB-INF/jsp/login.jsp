...
<nav class="navbar navbar-default" role="navigation" style="border-radius: 0px;">
    <div class="container-fluid">
        <div class="navbar-header">
            <b class="navbar-brand">爱动网商家系统</b>
        </div>
    </div>
</nav>
<div id="msg"></div>
        ...
        <table class="table">
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="${pageContext.request.contextPath}/toRegist.do"><button type="button" class="btn btn-info">注册</button></a>
                </td>
                <td></td>
            </tr>
            </tbody>
