            ...
            <div class="page-content">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-8" style="text-align: right">
                        <a href="${pageContext.request.contextPath}/pageItem.do?currentPage=${currentPage}">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="row" style="text-align: center;">
                            ...
                            <div class="col-xs-8">
                                <form action="${pageContext.request.contextPath}/addGood.do" method="post">
                                    ...
                                    <table id="simple-table" class="table  table-bordered table-hover" style="text-align: center;">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" value="${item.itemName}" class="form-control" disabled/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="width: 20%;">物品品牌:</td>
                                                <td>
                                                    <input type="text" value="${item.brand.brandName}" class="form-control" disabled/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="width: 20%;">适用者:</td>
                                                <td>
                                                    <input type="text" value="${item.applyer.applyerName}" class="form-control" disabled/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="width: 20%;">材质:</td>
                                                <td>
                                                    <input type="text" value="${item.material.materialName}" class="form-control" disabled/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>建议零售价格/元:</td>
                                                <td>
                                                    <input type="text" value="${item.suggestRetailPrice}" class="form-control" disabled/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="width: 20%;">当前库存:</td>
                                                <td>
                                                    <input type="text" value="${item.currentInventory}" class="form-control" disabled/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>上市时间:</td>
                                                <td>
                                                    <input type="text" value="<fmt:formatDate value="${item.timeToMarket}" pattern="yyyy年MM月dd日"/>" class="form-control" disabled/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="width: 20%;">图片:</td>
                                                <td>
                                                    <img style="width: 166px;" src="${item.picPath}"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="width: 20%;">商品名称:</td>
                                                <td>
                                                    <input type="text" name="goodName" class="form-control" placeholder="请输入商品名称"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="width: 20%;">原价:</td>
                                                <td>
                                                    <input type="text" name="originalPrice" class="form-control" placeholder="请输入原价"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>促销价:</td>
                                                <td>
                                                    <input type="text" name="salePrice" class="form-control" placeholder="请输入促销价"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td></td>
