                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="col-xs-8">
                            ...
                            <p style="text-align: center;"><span class="husen">第一步，填写基本信息</span></p>
                            <table class="table tab-color-blue table-bordered" style="text-align: center;">
                                <tr>
                                    <td style="vertical-align: middle; width: 25%;">用户名：</td>
                                    <td style="vertical-align: middle;">
                                        <input type="text" class="form-control" name="username" value="${sessionScope.boss.username}" disabled/>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="vertical-align: middle;">手机号：</td>
                                    <td style="vertical-align: middle;">
                                        <input type="text" class="form-control" name="phone" value="${sessionScope.boss.phone}" disabled/>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="vertical-align: middle;">店铺名字：</td>
                                    <td style="vertical-align: middle;">
                                        <input type="text" class="form-control" name="storesName"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="vertical-align: middle;">店铺地址：</td>
                                    <td style="vertical-align: middle;">
                                        <input type="text" class="form-control" name="address"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="vertical-align: middle;">主营运动类别：</td>
                                    <td style="vertical-align: middle;">
                                        <div class="checkbox">
                                            <c:forEach items="${sports}" var="sport">
                                                <label>
                                                    <input name="sport" value="${sport.sportId}" class="ltthk" type="checkbox">${sport.sportName}
                                                </label><br>
                                            </c:forEach>
                                        </div>
                                    </td>
                            ...
                            <div style="text-align: center;">
                                <button id="ltt" type="button" style="width: 100px;" class="btn btn-white btn-success">下一步</button>
                                <button type="button" style="width: 100px;" class="btn btn-white btn-warning">退出</button>
                            </div>
                        </div>
                        <div class="col-xs-2"></div>
                    </div>
