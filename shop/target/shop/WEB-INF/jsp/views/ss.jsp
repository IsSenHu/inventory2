    ...
    <div class="main-content">
        <div class="main-content-inner">
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="row" style="text-align: center; overflow-y: scroll;">
                            <p style="color: brown; font-size: 20px;">${msg}</p>
                            <div class="col-xs-1"></div>
                            <div id="detail" class="col-xs-10">
                                <table class="table table-bordered">
                                    <tr style="text-align: center;">
                                        <td style="width: 20%;">商品编号：</td>
                                        <td style="width: 30%;">${good.goodId}</td>
                                        <td style="width: 20%;">商品名称：</td>
                                        <td style="width: 30%;">${good.goodName}</td>
                                    </tr>
                                    <tr style="text-align: center;">
                                        <td style="width: 20%;">原价：</td>
                                        <td style="width: 30%;">${good.originalPrice}元</td>
                                        <td style="width: 20%;">促销价：</td>
                                        <td style="width: 30%;">${good.salePrice}元</td>
                                    </tr>
                                    <tr style="text-align: center;">
                                        <td style="width: 20%;">材质：</td>
                                        <td style="width: 30%;">${item.material.materialName}</td>
                                        <td style="width: 20%;">规格：</td>
                                        <td style="width: 30%;">${item.specification.specificationName}</td>
                                    </tr>
                                    <tr style="text-align: center;">
                                        <td style="width: 20%;">物品当前库存：</td>
                                        <td style="width: 30%;">${item.currentInventory}</td>
                                        <td style="width: 20%;">物品上架时间</td>
                                        <td style="width: 30%;"><fmt:formatDate value="${item.timeToMarket}" pattern="yyyy年MM月dd日"></fmt:formatDate></td>
                                    </tr>
                                    <tr style="text-align: center;">
                                        <td style="width: 20%;">物品品牌：</td>
                                        <td style="width: 30%;">${item.brand.brandName}</td>
                                        <td style="width: 20%;">适用者</td>
                                        <td style="width: 30%;">${item.applyer.applyerName}</td>
                                    </tr>
                                    <tr style="text-align: center;">
                                        <td style="width: 20%;">建议零售价：</td>
                                        <td style="width: 30%;">${item.suggestRetailPrice}元</td>
                                        <td style="width: 20%;">分类：</td>
                                        <td style="width: 30%;">${item.sportItem.sportItemName}</td>
                                    </tr>
                                    <tr style="text-align: center;">
                                        <td style="width: 20%;">物品图片：</td>
                                        <td style="width: 30%;" colspan="3">
                                            <img style="width: 160px;" src="${item.picPath}"/>
                                        </td>
                                    </tr>
                                    <tr style="text-align: center;">
                                        <td style="width: 20%;">商品详情图片：</td>
                                        <td style="width: 30%;" colspan="3">
                                            <img src="${good.detailpic}"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="4" style="text-align: center;">
                                            <button class="btn btn-primary">修改商品信息</button>
                                            <button class="btn btn-purple">编辑详情图片</button>
                                            <button class="btn btn-info">编辑其它图片</button>
                                            <button class="btn btn-pink">商品上架</button>
