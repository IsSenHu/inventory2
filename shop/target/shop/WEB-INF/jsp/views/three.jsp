            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="col-xs-8">
                            <form id="pageForm3" method="post" enctype="multipart/form-data">
                                <p style="text-align: center;"><span class="ltt">商家入驻</span></p>
                                <p style="text-align: center;"><span class="husen">第三步，身份认证</span></p>
                                <table class="table tab-color-blue table-bordered" style="text-align: center;">
                                    <tr>
                                        <td style="vertical-align: middle; width: 25%;">真实姓名：</td>
                                        <td style="vertical-align: middle;">
                                            <input type="text" class="form-control" name="realName"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="vertical-align: middle;">身份证号：</td>
                                        <td style="vertical-align: middle;">
                                            <input type="text" class="form-control" name="cardId"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="vertical-align: middle;">身份证正面：</td>
                                        <td style="vertical-align: middle;">
                                            <input id="cardBefore" type="file" class="form-control" name="cardBefore"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="vertical-align: middle;">身份证背面：</td>
                                        <td style="vertical-align: middle;">
                                            <input id="cardAfter" type="file" class="form-control" name="cardAfter"/>
                                        </td>
                                    </tr>
                                </table>
                                <div style="text-align: center;">
                                    <button id="ltt3" type="button" style="width: 100px;" class="btn btn-white btn-success">下一步</button>
                                    <button id="husen" type="button" style="width: 100px;" class="btn btn-white btn-warning">上一步</button>
                                </div>
                            </form>
                        </div>
                        <div class="col-xs-2"></div>
