                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="col-xs-8">
                            <form id="pageForm" method="post" enctype="multipart/form-data">
                                ...
                                <p style="text-align: center;"><span class="husen">第二步，认证营业资格</span></p>
                                <table class="table tab-color-blue table-bordered" style="text-align: center;">
                                    <tr>
                                        <td style="vertical-align: middle; width: 25%;">营业执照注册号：</td>
                                        <td style="vertical-align: middle;">
                                            <input type="text" class="form-control" name="registNumber"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="vertical-align: middle;">示例：</td>
                                        <td style="vertical-align: middle;">
                                            <img style="height:266px; border: 1px solid #000000;" src="img/yyzz.jpg"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="vertical-align: middle;">营业执照照片：</td>
                                        <td style="vertical-align: middle;">
                                ...
                                <div style="text-align: center;">
                                    <button id="ltt2" type="button" style="width: 100px;" class="btn btn-white btn-success">下一步</button>
                                    <button id="husen2" type="button" style="width: 100px;" class="btn btn-white btn-warning">上一步</button>
                                </div>
                            </form>
                        </div>
                        <div class="col-xs-2"></div>
